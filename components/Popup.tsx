    ...
    >
      <div className="bg-white rounded-lg p-8 max-w-md w-full mx-4">
        <div className="flex justify-between items-start mb-4">
          <h2 className="text-2xl font-bold text-gray-900">Be among the first to try Tide!</h2>
          <button onClick={() => setIsOpen(false)} className="text-gray-400 hover:text-gray-500">
            <X className="h-6 w-6" />
          </button>
        </div>
        <p className="text-gray-600 mb-4">
          Signing up helps us know what our users prefer. It also helps us to keep remembering what's at stake. Love,
          Otto :)
        </p>
        ...
        <p className="mt-4 text-xs text-gray-500 text-center">We will never spam you or share your email</p>
      </div>
    </div>
  )
}
